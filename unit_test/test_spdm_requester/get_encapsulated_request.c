...
static void req_get_encapsulated_request_case14(void **State)
{
    ...
    spdm_context->local_context.local_cert_chain_provision[spdm_context->local_context.current_bank][0] = NULL;
    spdm_context->local_context.local_cert_chain_provision_size[spdm_context->local_context.current_bank][0] = 0;
