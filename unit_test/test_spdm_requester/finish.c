...
static void req_finish_case16(void **state)
{
    ...
    local_cert_chain_provision_size[spdm_context->local_context.current_bank][req_slot_id_param] = data_size;
    spdm_context->local_context.
    local_cert_chain_provision[spdm_context->local_context.current_bank][req_slot_id_param] = data;
