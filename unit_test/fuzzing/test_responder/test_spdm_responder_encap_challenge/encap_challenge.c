...
void libspdm_test_responder_encap_challenge_case1(void **State)
{
    ...
    libspdm_hash_all(m_libspdm_use_hash_algo,
                     (spdm_context)->local_context.local_cert_chain_provision[spdm_context->local_context.current_bank][
                         0],
                     (spdm_context)->local_context.local_cert_chain_provision_size[spdm_context->local_context.
                                                                                   current_bank][
                         0], ptr);
