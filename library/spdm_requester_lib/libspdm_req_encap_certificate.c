                                                        ...
                                                        void *response)
{
    ...
    if (context->local_context.local_cert_chain_provision[context->local_context.current_bank][slot_id] == NULL) {
        return libspdm_generate_encap_error_response(
    ...
    *response_size = rsp_msg_header_size + length;
    ...
    libspdm_copy_mem((uint8_t *)spdm_response + rsp_msg_header_size,
                     ...
                     .local_cert_chain_provision[context->local_context.current_bank][slot_id] + offset, length);
